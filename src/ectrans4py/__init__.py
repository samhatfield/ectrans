...
def dist_spec4py(KSPEC2G, KSPEC2, KFLD, KFROM, PSPECG):
    ...
    return ([KSPEC2G, KSPEC2, KFLD, KFROM, PSPECG],
            [(np.int64, None, IN),
             ...
             (np.int64, None, IN),
             (np.int64, (KFLD,), IN),
             (np.float32, (KFLD, KSPEC2G), IN),
             (np.float32, (KFLD, KSPEC2), OUT)],
            None)
...
def gath_spec4py(KSPEC2G, KSPEC2, KFLD, KTO, PSPEC):
    ...
    return ([KSPEC2G, KSPEC2, KFLD, KTO, PSPEC],
            [(np.int64, None, IN),
             ...
             (np.int64, None, IN),
             (np.int64, (KFLD,), IN),
             (np.float32, (KFLD, KSPEC2), IN),
             (np.float32, (KFLD, KSPEC2G), OUT)],
            None)
...
def dist_grid4py(KGPTOTG, KGPTOT, KFLD, KFROM, PGPG):
    ...
    return ([KGPTOTG, KGPTOT, KFLD, KFROM, PGPG],
            [(np.int64, None, IN),
             ...
             (np.int64, None, IN),
             (np.int64, (KFLD,), IN),
             (np.float32, (KFLD, KGPTOTG), IN),
             (np.float32, (KFLD, KGPTOT), OUT)],
            None)
...
def gath_grid4py(KGPTOTG, KGPTOT, KFLD, KTO, PGP):
    ...
    return ([KGPTOTG, KGPTOT, KFLD, KTO, PGP],
            [(np.int64, None, IN),
             ...
             (np.int64, None, IN),
             (np.int64, (KFLD,), IN),
             (np.float32, (KFLD, KGPTOT), IN),
             (np.float32, (KFLD, KGPTOTG), OUT)],
            None)
