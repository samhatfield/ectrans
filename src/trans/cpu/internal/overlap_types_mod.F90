...
!        USE COMMON_MOD
    ...
    SUBROUTINE START_COMM(THIS, PGP, IREQ_RECV, PGTF)
        ...
        CALL TRGTOL_COMM_SEND(PGTF(THIS%IOFFGTF:THIS%IOFFGTF+THIS%NF_FS-1,:), THIS%NF_FS, &
          ...
          &                   THIS%NGPTRSEND, THIS%PCOMBUFS, THIS%PCOMBUFR, IREQ_RECV, &
          &                   THIS%NPTRGP, PGP)
    ...
    SUBROUTINE FINISH_COMM(THIS, PGTF, IREQ_RECV, PSPVOR, PSPDIV, PSPSCALAR)
      ...
      CALL TRGTOL_COMM_RECV(PGTF(THIS%IOFFGTF:THIS%IOFFGTF+THIS%NF_FS-1,:), THIS%NF_FS, &
        ...
        &                   THIS%NINDEX, THIS%NNDOFF, THIS%PCOMBUFR, IREQ_RECV)
