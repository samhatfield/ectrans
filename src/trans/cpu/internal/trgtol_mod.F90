...
INTEGER(KIND=JPIM) :: ISEND_FLD_START,ISEND_FLD_END_2
...
!$OMP PARALLEL PRIVATE(JBLK,IFIRST,ILAST,ISEND_FLD_START,ISEND_FLD_END_2,INS,ISEND,ISETA,ISETB,&
...
DO INS=1,KNSEND
  ...
  ISEND_FLD_END_2 = PCOMBUFS(0,INS)

!$OMP DO SCHEDULE(STATIC)
  DO JJ=ISEND_FLD_START,ISEND_FLD_END_2
    IFLDT=IFLDA(JJ,INS)
    DO JBLK=1,NGPBLKS
      IFIRST = KGPTRSEND(1,JBLK,ISETW(INS))
      IF(IFIRST > 0) THEN
...
INTEGER(KIND=JPIM) :: JNR, INR, IRECV, ILEN, IRECV_FLD_START, IRECV_FLD_END_2, JL, II, JFLD
