...
SUBROUTINE TRLTOM_SEND(PFBUF_IN,PFBUF,KFIELD,A2AREQ,ILENS,ILENR,IOFFS,IOFFR)
...
INTEGER(KIND=JPIM),INTENT(IN)  :: KFIELD
REAL(KIND=JPRB)   ,INTENT(INOUT), CONTIGUOUS  :: PFBUF(:)
REAL(KIND=JPRB)   ,INTENT(INOUT), CONTIGUOUS  :: PFBUF_IN(:)
INTEGER(KIND=JPIM),INTENT(OUT) :: A2AREQ

INTEGER(KIND=JPIM),INTENT(IN) :: ILENS(NPRTRW),IOFFS(NPRTRW),ILENR(NPRTRW),IOFFR(NPRTRW)

INTEGER(KIND=JPIM) :: ITAG, J, ILEN, ISTA,IERR
