...
USE TPM_FIELDS            ,ONLY : FIELDS_RESOL, F,F_RW, F_RN, F_RLAPIN, ZIA,ZEPSNM,ZSOA1,ZAOA1,ISTAN,ISTAS,ZAIA,ZOA1,ZOA2, &
...
#ifdef OMPGPU
!WARNING: following ALLOC statement should be PRESENT,ALLOC but cause issues with AMD compiler!
!$OMP TARGET ENTER DATA MAP(ALLOC:ZGTFTMP)
#endif
#endif
...
#ifdef OMPGPU
!WARNING: following ALLOC statement should be PRESENT,ALLOC but cause issues with AMD compiler!
!$OMP TARGET ENTER DATA MAP(ALLOC:ZIA,ZEPSNM,ZSOA1,ZAOA1,ZAIA,ZOA1,ZOA2)
#endif
...
#ifdef OMPGPU
!WARNING: following ALLOC statement should be PRESENT,ALLOC but cause issues with AMD compiler!
!$OMP TARGET ENTER DATA MAP(ALLOC:ZAVE,ZMINGL,ZMAXGL,ZMINGPN,ZMAXGPN)
#endif
...
!$ACC&                  G_NLOEN_MAX,F_RW,F_RLAPIN,F_RN)
#endif
#ifdef OMPGPU
...
!$OMP TARGET ENTER DATA MAP(TO:G_NLOEN_MAX,F_RW,F_RLAPIN,F_RN)
#endif
