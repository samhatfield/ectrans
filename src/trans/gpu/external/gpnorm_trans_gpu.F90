...
IF( IF_FS > 0 )THEN
  ...
  !$OMP TARGET DATA MAP(PRESENT,ALLOC:ZGTF,ZAVE,ZMINGL,ZMAXGL,ZMINGPN,ZMAXGPN)
#endif
#ifdef OMPGPU
  !$OMP TARGET TEAMS DISTRIBUTE PARALLEL DO MAP(TO:F,D,D_NSTAGTF,D_NPTRLS,G_NLOEN)
#endif
  DO JF=1,IF_FS
