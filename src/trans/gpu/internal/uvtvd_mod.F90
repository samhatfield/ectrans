...
!$OMP& SHARED(D,D_NUMP,D_MYMS,KF_UV,R,R_NTMAX,PU,PV) MAP(TO:KF_UV) DEFAULT(NONE)
#endif
#ifdef ACCGPU
...
!$OMP& SHARED(D,D_NUMP,D_MYMS,R,R_NTMAX,KF_UV,FG,ZEPSNM,PVOR,PV,PU,PDIV) DEFAULT(NONE)
#endif
#ifdef ACCGPU
