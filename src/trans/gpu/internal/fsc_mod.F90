...
#ifdef OMPGPU
!$OMP TARGET DATA &
!$OMP& MAP(PRESENT,ALLOC:D,D_NPTRLS,D_NSTAGTF,PREEL_COMPLEX,G,G_NMEN,G_NLOEN) MAP(TO:R,F)
#endif
#ifdef ACCGPU
!$ACC DATA &
!$ACC& PRESENT(D,D_NPTRLS,D_NSTAGTF,PREEL_COMPLEX,F,F%RACTHE,G,G_NMEN,G_NLOEN,R,R%NSMAX)
#endif
