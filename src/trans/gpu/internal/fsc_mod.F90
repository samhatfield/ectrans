...
!$OMP& SHARED(IBEG,IEND,IINC,KF_UV,R,R_NSMAX,OFFSET_VAR,G,G_NMEN,D,D_NSTAGTF,KF_FS,KUV_OFFSET,&
!$OMP& PREEL_COMPLEX,F,F_RACTHE) MAP(TO:IBEG,IEND,IINC,KF_UV,OFFSET_VAR,KF_FS,KUV_OFFSET)
#endif
#ifdef ACCGPU
...
IF (KSCALARS_NSDER_OFFSET >= 0) THEN
  ...
  !$OMP& SHARED(IBEG,IEND,IINC,KF_SCALARS,R,R_NSMAX,OFFSET_VAR,G,G_NMEN,D,D_NSTAGTF,KF_FS, &
  !$OMP&        KSCALARS_NSDER_OFFSET,F,F_RACTHE,PREEL_COMPLEX) &
...
IF (KUV_EWDER_OFFSET >= 0) THEN
  ...
  !$OMP& SHARED(IBEG,IEND,IINC,KF_UV,ILOEN_MAX,OFFSET_VAR,G,G_NLOEN,G_NMEN,D,D_NSTAGTF,KF_FS, &
  !$OMP&        KUV_OFFSET,KUV_EWDER_OFFSET,F,F_RACTHE,PREEL_COMPLEX) &
...
IF (KSCALARS_EWDER_OFFSET > 0) THEN
  ...
  !$OMP& SHARED(IBEG,IEND,IINC,KF_SCALARS,ILOEN_MAX,OFFSET_VAR,G,G_NLOEN,G_NMEN,D,D_NSTAGTF,KF_FS,&
  !$OMP&        KSCALARS_EWDER_OFFSET,KSCALARS_OFFSET,F,F_RACTHE,PREEL_COMPLEX) &
