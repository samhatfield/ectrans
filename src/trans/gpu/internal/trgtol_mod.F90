...
MODULE TRGTOL_MOD
  ...
  INTEGER(KIND=JPIM) :: IRECV_FLD_CNT
  ...
  DO INR=1,INRECV
      ...
      IRECV_FLD_CNT   = ICOMBUFR_FLD(INR)
      !$ACC PARALLEL LOOP COLLAPSE(2) DEFAULT(NONE) PRIVATE(II) COPYIN(IRECV,ILEN,IRECV_FLD_CNT)
      DO JFLD=1,IRECV_FLD_CNT
        DO JL=1,ILEN
