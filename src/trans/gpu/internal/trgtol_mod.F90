...
MODULE TRGTOL_MOD
  ...
  INTEGER(KIND=JPIM) :: IFIRST, IFIRSTLAT, IGL, IGLL, ILAST,&
               ...
               &II,INDOFFX,IBUFLENR,INRECV, IPROC,IFLDS, &
    ...
    IF(IRECVTOT(JROC) > 0) THEN
      ...
      DO JGL=IFIRSTLAT,ILASTLAT
        ...
        DO JL=1,D%NONL(IGL,ISETB)
          ...
          KINDEX(INDOFF(JROC)+IPOS) = D%NSTA(IGL,ISETB)+D%NSTAGTF(IGLL)+JL-1
        ENDDO
      ENDDO
    ENDIF
  ENDDO
