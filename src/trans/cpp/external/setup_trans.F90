...
USE, INTRINSIC :: ISO_C_BINDING, ONLY: C_BOOL, C_INT, C_PTR, C_SIZE_T, C_LOC, C_NULL_PTR
...
SUBROUTINE SETUP_TRANS_CPP_BINDING_SP(KSMAX, KDGL, KDLON, KLOEN, KRESOL) &
  ...
  TYPE(C_PTR),         VALUE,    INTENT(IN)    :: KDLON
...
TYPE(C_PTR) :: KDLON_PTR, KRESOL_PTR
INTEGER(KIND=C_INT), TARGET :: IDLON, IRESOL

IF (PRESENT(KDLON)) THEN
  IDLON = KDLON
  KDLON_PTR = C_LOC(IDLON)
ELSE
  KDLON_PTR = C_NULL_PTR
ENDIF
...
#ifdef TRANS_SINGLE
CALL SETUP_TRANS_CPP_BINDING_SP(KSMAX, KDGL, KDLON_PTR, KLOEN, KRESOL_PTR)
#else
CALL SETUP_TRANS_CPP_BINDING_DP(KSMAX, KDGL, KDLON_PTR, KLOEN, KRESOL_PTR)
#endif
