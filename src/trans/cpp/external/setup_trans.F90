...
INTERFACE
SUBROUTINE SETUP_TRANS_CPP_BINDING_SP(KSMAX, KDGL, KDLON, KRESOL) BIND(C, NAME="setup_trans_sp")
...
SUBROUTINE SETUP_TRANS_CPP_BINDING_DP(KSMAX, KDGL, KDLON, KRESOL) BIND(C, NAME="setup_trans_dp")
  USE, INTRINSIC :: ISO_C_BINDING, ONLY: C_INT
  INTEGER(KIND=C_INT), VALUE, INTENT(IN)    :: KSMAX
  INTEGER(KIND=C_INT), VALUE, INTENT(IN)    :: KDGL
  INTEGER(KIND=C_INT), VALUE, INTENT(IN)    :: KDLON
...
#ifdef TRANS_SINGLE
CALL SETUP_TRANS_CPP_BINDING_SP(KSMAX, KDGL, IDLON, IRESOL)
#else
CALL SETUP_TRANS_CPP_BINDING_DP(KSMAX, KDGL, IDLON, IRESOL)
#endif
